...
def plotting(plot_objects, stars_orba, stars_mass, mask_immortal, starsin_orba, starsin_mass, starsretro_orba, starsretro_mass,
    ...
    if (plot_objects == 0) or (plot_objects == 1):
        ...
        plt.scatter(star_merge_orba, star_merge_mass, marker="d", edgecolor=color_event, facecolor="None", zorder=star_zorder)
        plt.scatter(star_explode_orba, star_explode_mass, marker="X", edgecolor=color_event, facecolor="None", zorder=star_zorder)
        ...
        plt.scatter(0, -10, label=nomask_label, edgecolor=color_star, facecolor='None')
        plt.scatter(0, -10, label=mask_label, edgecolor=color_immortal, facecolor='None')
        plt.scatter(0, -10, marker="d", label=star_merge_label, edgecolor=color_event, facecolor='None')
        plt.scatter(0, -10, marker="X", label=star_explode_label, edgecolor=color_event, facecolor='None')
    ...
    if (plot_objects == 0) or (plot_objects == 2):
        ...
        plt.scatter(bbh_merge_orba, bbh_merge_mass, marker="D", edgecolor=color_event, facecolor=color_event, zorder=bbh_zorder)
        ...
        plt.scatter(0, -10, label=bh_label, edgecolor=color_bh, facecolor='None')
        plt.scatter(0, -10, label=bbh_label, edgecolor=color_bbh, facecolor='None')
        plt.scatter(0, -10, marker="D", label=bbh_merge_label, edgecolor=color_event, facecolor='None')
        if bh_unbound_flag is True:
