...
DEFAULT_SETTINGS: list[SettingsProperty | StaticSettingsProperty] = [
        ...
        SettingsProperty("torque_prescription", "disk", "jimenez_masset", str),
        ...
        SettingsProperty("fraction_bin_retro", "bh", 0.5, float),
        ...
        SettingsProperty("flag_thermal_feedback", "bh", False, bool),
