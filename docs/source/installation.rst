...
Our default inputs are located at `./recipes/model_choice_old.ini`_. Edit this file or create your own
:code:`model_choice.ini` file with different inputs.
...
.. _`./recipes/model_choice_old.ini`: https://github.com/McFACTS/McFACTS/blob/main/recipes/model_choice_old.ini