...
def accretion_bh_spin_params():
    ...
    return zip(disk_bh_spin, disk_bh_orbital_eccentricity, expected_spin)
...
@pytest.mark.parametrize("disk_bh_spin, disk_bh_orbital_eccentricity, expected_spin", accretion_bh_spin_params())
@pytest.mark.parametrize("disk_bh_spin_angles, disk_bh_orbital_eccentricity, expected_spin_angle", accretion_bh_spin_angle_params())

def test_change_bh_spin(disk_bh_spin, disk_bh_pro_spin_angles, disk_bh_orbital_eccentricity, expected_spin, expected_spin_angle):
